...
namespace reproopeniddictpasswordgrant.Migrations
{
    ...
    [Migration("20160817093746_initial")]
    partial class initial
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("repro_openiddict_passwordgrant.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("repro_openiddict_passwordgrant.Models.ApplicationUser")
                        .WithMany("Claims")
